...
def create_scenario(with_interaction=True):
    ...
    humanA = Human(x=2.0, y=1.5, theta=-152.0 / 180.0 * 3.14, velocity=0.0, confidence=1.0)

    object_interactions_hA = [ObjectInteraction(object1, 0.8),
                              ObjectInteraction(object2, 0.2)] if with_interaction else []
